...
namespace TDFKinectGreenScreen.Model.TDFDatablocks
{
    ...
    internal class ComposeImagesBlock : ISourceBlock<BitmapSource>
    {
        ...
        /// </summary>
        public ITargetBlock<DepthImageFrameInfo> DepthCameraTarget => _joinSources.Target1;

        /// <summary>
        /// Connect the color sensor source here
        /// </summary>
        public ITargetBlock<ColorImageFrameInfo> ColorCameraTarget => _joinSources.Target2;

        /// <summary>
        /// Connect the background image source here
        /// </summary>
        public ITargetBlock<BitmapSource> ImageTarget => _imageUpdater;
        ...
        public Task Completion => _resultBlock.Completion;
